...
-- This SQL is injected into a Prisma migration created by:
--   pnpm --filter @mnela/db prisma migrate dev --create-only --name fts_extensions
-- See packages/db/README.md for the bootstrap procedure.
