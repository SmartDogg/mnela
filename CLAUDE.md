...
- `docs/dev/DECISIONS.md` (ADRs), `docs/dev/QUESTIONS.md` (open issues), and `docs/dev/PLAN.md` (phase plan) are the source of truth for architecture choices.
